...
def main_ui():
    ...
    load_randnum_button.grid(row=1, column=1, rowspan=1, sticky="w", padx=5, pady=5)
    ...
    output1 = tk.Text(output_group, bg="lightgray", height=1, wrap="word", font=("Arial", 12))
    outputE = tk.Text(output_group, bg="lightgray", height=2, wrap="word", font=("Arial", 8))
    output2 = tk.Text(output_group, bg="lightgray", height=3, wrap="word", font=("Arial", 12))
    output3 = tk.Text(output_group, bg="lightgray", height=4, wrap="word", font=("Arial", 12))
    output4 = tk.Text(output_group, bg="lightgray", height=1, wrap="word", font=("Arial", 12))
