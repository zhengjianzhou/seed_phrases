        ...
        try:
            ...
            class MainUI(BoxLayout):
                def __init__(self, **kwargs):
                    ...
                    # Top Section: Options and Text Input
                    top_section = BoxLayout(orientation='vertical')
                    ...
                    top_section.add_widget(options_box)
                    # Text Inputs
                    text_input_box = BoxLayout(orientation='vertical')
                    self.text_phrases = TextInput(hint_text='Text Phrases', multiline=False, font_name=r"/System/Library/Fonts/STHeiti Light.ttc")
                    text_input_box.add_widget(self.text_phrases)
                    self.text_passcode = TextInput(hint_text='Passcode', multiline=False, font_name=r"/System/Library/Fonts/STHeiti Light.ttc")
                    text_input_box.add_widget(self.text_passcode)
                    top_section.add_widget(text_input_box)
                    root.add_widget(top_section)
            
                    # Image Input Section
                    mid_section = BoxLayout(orientation='vertical')
                    image_box = BoxLayout(orientation='horizontal')
                    self.pad = PixelPad(size_hint=(0.6, 0.6))
                    image_box.add_widget(self.pad)
                    right_panel = BoxLayout(orientation='vertical', padding=0, spacing=0)
                    buttons_column = BoxLayout(orientation='vertical')
                    buttons_column.add_widget(Button(text='Save', on_press=lambda x: self.pad.save_image(), size_hint_y=None, height=88))
                    buttons_column.add_widget(Button(text='Load', on_press=lambda x: self.pad.load_image(), size_hint_y=None, height=88))
                    buttons_column.add_widget(Button(text='Clear', on_press=lambda x: self.pad.clear_image(), size_hint_y=None, height=88))
                    buttons_column.add_widget(Button(text='Generate Random', on_press=lambda x: self.pad.generate_random(), size_hint_y=None, height=88))
                    right_panel.add_widget(buttons_column)
                    self.bitstring_input = TextInput(text=self.pad.bitstring, multiline=True, size_hint_y=None, height=250)
                    ...
                    mid_section.add_widget(image_box)
                    root.add_widget(mid_section)
            
                    # Generate Button
                    gen_section = BoxLayout(orientation='vertical', size_hint_y=None, height=60)
                    gen_section.add_widget(Button(text='Generate Seed Phrases', on_press=self.generate_output))
                    root.add_widget(gen_section)
                    # Output Section
                    low_section = BoxLayout(orientation='vertical', padding=10, spacing=5)
                    self.output1 = TextInput(readonly=True, hint_text='Input Text Phrases'   , multiline=True, font_name=r"/System/Library/Fonts/STHeiti Light.ttc")
                    self.output2 = TextInput(readonly=True, hint_text='Seed / Entropy'   , multiline=True)
                    self.output3 = TextInput(readonly=True, hint_text='Seed Phrases'   , multiline=True, font_name=r"/System/Library/Fonts/STHeiti Light.ttc")
                    self.output4 = TextInput(readonly=True, hint_text='Seed Phrases Indexed', multiline=True, font_name=r"/System/Library/Fonts/STHeiti Light.ttc")
                    self.output5 = TextInput(readonly=True, hint_text='Pass Phrases', multiline=False)
                    self.output0 = TextInput(readonly=True, hint_text='Checksum', multiline=False)
                    low_section.add_widget(self.output0)
                    low_section.add_widget(self.output1)
                    low_section.add_widget(self.output2)
                    low_section.add_widget(self.output3)
                    low_section.add_widget(self.output4)
                    low_section.add_widget(self.output5)
                    root.add_widget(low_section)
